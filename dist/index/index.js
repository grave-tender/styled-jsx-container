...
var StyleSheet = /*#__PURE__*/ (function () {
  function StyleSheet(param) {
    var _ref = param === void 0 ? {} : param,
      _ref_name = _ref.name,
      name = _ref_name === void 0 ? 'stylesheet' : _ref_name,
      _ref_optimizeForSpeed = _ref.optimizeForSpeed,
      optimizeForSpeed =
        _ref_optimizeForSpeed === void 0 ? isProd : _ref_optimizeForSpeed
      ...
      if (tag) {
        rules = rules.concat(
          Array.prototype.map.call(
            ...
            function (rule) {
              return rule.cssText === _this._deletedRulePlaceholder
                ? null
                : rule
            }
          )
...
var StyleSheetRegistry = /*#__PURE__*/ (function () {
  function StyleSheetRegistry(param) {
    var _ref = param === void 0 ? {} : param,
      _ref_styleSheet = _ref.styleSheet,
      styleSheet = _ref_styleSheet === void 0 ? null : _ref_styleSheet,
      _ref_optimizeForSpeed = _ref.optimizeForSpeed,
      optimizeForSpeed =
        _ref_optimizeForSpeed === void 0 ? false : _ref_optimizeForSpeed
    this._sheet =
      styleSheet ||
      new StyleSheet({
        name: 'styled-jsx',
  ...
  _proto.add = function add(props) {
    ...
    var _this_getIdAndRules = this.getIdAndRules(props),
      styleId = _this_getIdAndRules.styleId,
      rules = _this_getIdAndRules.rules
